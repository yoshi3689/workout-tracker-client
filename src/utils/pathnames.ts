...
export const PATHNAMES = {
  ...
  PASSWORD_RESET_SEND: "/send-reset-password/",
  PASSWORD_RESET_BEFORE_LINK_CLICKED: "/reset-password/",
  PASSWORD_RESET_AFTER_LINK_CLICKED: "/reset-password/:usernameEncoded/",
